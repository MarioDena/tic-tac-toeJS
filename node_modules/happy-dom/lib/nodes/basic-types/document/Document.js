...
var HTMLTemplateElement_1 = __importDefault(require("../../elements/template/HTMLTemplateElement"));
var HTMLFormElement_1 = __importDefault(require("../../elements/form/HTMLFormElement"));
var HTMLInputElement_1 = __importDefault(require("../../elements/input/HTMLInputElement"));
var HTMLTextAreaElement_1 = __importDefault(require("../../elements/text-area/HTMLTextAreaElement"));
var SVGSVGElement_1 = __importDefault(require("../../elements/svg/SVGSVGElement"));
...
var SVGElements_json_1 = __importDefault(require("../../../html-config/SVGElements.json"));
var SVGElement_1 = __importDefault(require("../../elements/svg/SVGElement"));
/**
 * Document.
 */
var Document = /** @class */ (function (_super) {
    ...
    Document.prototype.getElementClass = function (tagName) {
        switch (tagName) {
            case 'template':
                return HTMLTemplateElement_1.default;
            case 'form':
                return HTMLFormElement_1.default;
            case 'input':
                return HTMLInputElement_1.default;
            case 'textarea':
                return HTMLTextAreaElement_1.default;
            case 'svg':
                return SVGSVGElement_1.default;
        }
        if (SVGElements_json_1.default.includes(tagName)) {
            return SVGElement_1.default;
        }
