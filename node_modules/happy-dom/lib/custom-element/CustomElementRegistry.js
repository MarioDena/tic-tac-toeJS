...
var CustomElementRegistry = /** @class */ (function () {
     ...
     */
    CustomElementRegistry.prototype.define = function (tagName, elementClass) {
        if (!tagName.includes('-')) {
            throw new Error("Failed to execute 'define' on 'CustomElementRegistry': \"" + tagName + '" is not a valid custom element name.');
        }
        this._registry[tagName.toLowerCase()] = elementClass;
        if (this._callbacks[tagName]) {
            for (var _i = 0, _a = this._callbacks[tagName]; _i < _a.length; _i++) {
                var callback = _a[_i];
                callback();
            }
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, new Promise(function (resolve) {
                        _this._callbacks[tagName] = _this._callbacks[tagName] || [];
                        _this._callbacks[tagName].push(resolve);
                    })];
            });
        });
    };
